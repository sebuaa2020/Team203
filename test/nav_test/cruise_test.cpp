...
void Init_WayPoints()
{
    ...
    newWayPoint.target_pose.pose.position.x = 2;
    newWayPoint.target_pose.pose.position.y = 0;
    q.setRPY( 0, 0, 0 );
    newWayPoint.target_pose.pose.orientation.x = q.x();
    newWayPoint.target_pose.pose.orientation.y = q.y();
    ...
    newWayPoint.target_pose.pose.position.x = -4;
    newWayPoint.target_pose.pose.position.y = -5.6;
    q.setRPY( 0, 0, 0 );
    newWayPoint.target_pose.pose.orientation.x = q.x();
    newWayPoint.target_pose.pose.orientation.y = q.y();
    newWayPoint.target_pose.pose.orientation.z = q.z();
    ...
    newWayPoint.target_pose.pose.position.x = 1.1;
    newWayPoint.target_pose.pose.position.y = 3;
    q.setRPY( 0, 0, 1.57 );
    newWayPoint.target_pose.pose.orientation.x = q.x();
    newWayPoint.target_pose.pose.orientation.y = q.y();
    newWayPoint.target_pose.pose.orientation.z = q.z();
